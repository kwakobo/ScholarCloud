...
final class ACMParserTest extends TestCase
{
    public function testParse(): void
    {
      ...
      $output[0]['bibtex'] = "http://dl.acm.org/downformats.cfm?id=944598&parent_id=&expformat=bibtex&CFID=917729876&CFTOKEN=25999586";
      $this->assertEquals(
          $output,
      ...
      $output[1]['bibtex'] = "http://dl.acm.org/downformats.cfm?id=1629612&parent_id=&expformat=bibtex&CFID=917731681&CFTOKEN=37526761";
