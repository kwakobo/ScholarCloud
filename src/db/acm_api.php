...
class ACM_API
{
	...
	private function createArticleArray($json, $top, $url_bibtex)
	{
	...
	private function get_abstract($url)
	{
	...
	function get_acm($author, $hc)
	{
		...
		$articles = $this->createArticleArray($response, $hc, $url_bibtex);
